...
#EXTERNALS_DIR = os.path.join(dirname(abspath(__file__)),PYTHON_DIR)
EXTERNALS_DIR = dirname(dirname(dirname(abspath(__file__))))
...
def make_directory(d):
    print "going to Creating directory: %s" % repr(d)
...
if __name__ == "__main__":
    ...
    PCBUILD_DIR = "{SRC_DIR}/PC/VS8.0/{CPU}".format(SRC_DIR = SRC_DIR, CPU = CPU)
	
    print "SRC_DIR ",SRC_DIR," PCBUILD_DIR=",PCBUILD_DIR
